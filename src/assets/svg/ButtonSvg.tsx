const ButtonSvg = (light?: boolean) => (
  <>
    <svg className="absolute top-0 left-0" width="21" height="44" viewBox="0 0 21 44">
      <path
        fill={light ? 'white' : 'none'}
        stroke={light ? 'white' : 'url(#btn-left)'} // mentioned in ButtonGradient.jsx
        strokeWidth="2"
    ...
    <svg className="absolute top-0 right-0" width="21" height="44" viewBox="0 0 21 44">
      <path
        fill={light ? 'white' : 'none'}
        stroke={light ? 'white' : 'url(#btn-right)'} // mentioned in ButtonGradient.jsx
        strokeWidth="2"
